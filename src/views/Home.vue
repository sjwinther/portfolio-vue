<template>
  <div class="fade-in">
    <div class="py-6 sm:py-12">
      ...
      <p class="-mt-4 sm:mt-0 mb-8 sm:mb-12">I'm a student at the Digital Design and Communication MSc programme at the IT-University of Copenhagen. I enjoy designing digital interfaces and working with user experiences. I'm motivated by building stuff and learning from it.</p>
      ...
      <ul class="grid list-reset lg:-mx-12 -mt-4">
        ...
        <router-link v-for="(project, index) in projects" :to="'/project/' + project.uid" :key="index" tag="li" class="grid-item">
          <a class="group h-full flex flex-col justify-end rounded-sm shadow hover:shadow-lg overflow-hidden hover:translate-y--1">
            ...
            <span class="relative block text-lg bg-white transition border-t border-grey-lighter px-6 py-3">
